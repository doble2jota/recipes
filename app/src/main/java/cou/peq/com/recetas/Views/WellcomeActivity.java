...
public class WellcomeActivity extends AppCompatActivity {
    ...
    private void setIndicator(int index){
        if(index < NUM_PAGES){
            for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
                ...
                if(i == index){
                    circle.setColorFilter(getResources().getColor(android.R.color.black));
                }else {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            WellcomeFragment tp = null;
            switch(position){
                case 0:
                    tp = WellcomeFragment.newInstance(R.layout.welcome_fragment1);
                    break;
                case 1:
                    tp = WellcomeFragment.newInstance(R.layout.welcome_fragment2);
                    break;
                case 2:
                    tp = WellcomeFragment.newInstance(R.layout.welcome_fragment3);
                    break;
                case 3:
                    tp = WellcomeFragment.newInstance(R.layout.welcome_fragment4);
                    break;
                case 4:
                    tp = WellcomeFragment.newInstance(R.layout.welcome_fragment5);
                    break;
                case 5:
                    endTutorial();
                    break;
